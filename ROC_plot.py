...
def main():
    ...
    for i in range(8):
        ...
        fpr_i, tpr_i, roc_auc_i = calcuate_roc_sources(i+1, 'cd8')
        fpr.append(fpr_i)
        tpr.append(tpr_i)
    ...
    print(f'get save result')
    np.save('data/roc_data/np_fpr.npy', np_fpr)
    np.save('data/roc_data/np_tpr.npy', np_tpr)
    np.save('data/roc_data/np_roc_auc.npy', np_roc_auc)
